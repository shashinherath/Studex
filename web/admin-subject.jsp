...
<%@ page import="studex.classes.ManageAdminSubject, java.util.List, studex.classes.Subject" %>
...
<%
    ...
    ManageAdminSubject manager = new ManageAdminSubject();
    String message = "";

    if ("add".equals(action)) {
        String name = request.getParameter("name");
        message = manager.addSubject(name);
    } else if ("delete".equals(action)) {
        int subjectId = Integer.parseInt(request.getParameter("subject_id"));
        message = manager.deleteSubject(subjectId);
    } else if ("getSubject".equals(action)) {
        int subjectId = Integer.parseInt(request.getParameter("subject_id"));
        ...
        String json = "{";
        json += "\"subjectId\":\"" + subject.getSubjectId()+ "\",";
        ...
        message = manager.updateSubject(subjectId, name);
    }

    List<Subject> subjects = manager.getAllSubject();
...
<html lang="en">
    ...
    <body class="text-gray-800 font-inter">
        ...
        <main
            ...
            <!-- Content -->
            <div>
                <h1 class="text-4xl font-bold pl-10 pt-10">Subjects</h1>
            </div>
            <div class="border border-gray-300 rounded-lg shadow-md mx-10 bg-white my-10">
                <div class="container mx-auto p-10">
                    ...
                    <button onclick="document.getElementById('addModal').classList.remove('hidden')" 
                            class="bg-blue-500 text-white px-4 py-2 rounded mb-4">Add New Subject</button>
                    ...
                    <table class="table-auto w-full bg-white shadow-md rounded">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="border px-4 py-2"><%= subject.getSubjectId()%></td>
                                <td class="border px-4 py-2"><%= subject.getName()%></td>
                                <td class="border px-4 py-2">
                                    <form method="post" style="display:inline;" onsubmit="openUpdateModal(<%= subject.getSubjectId() %>)">
                                        <input type="hidden" name="action" value="getSubject">
            ...
            <div id="addModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center hidden">
                <div class="bg-white p-4 rounded shadow-lg w-96">
                    ...
                    <form method="post" action="admin-subject.jsp">
            ...
            <div id="updateModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center hidden">
                <div class="bg-white p-4 rounded shadow-lg w-96">
                    <h2 class="text-xl font-bold mb-4">Update Subject</h2>
                    <form id="updateForm" method="post" action="admin-subject.jsp">
    ...
    <script>
                            ...
                            function openUpdateModal(subjectId) {
                                ...
                                fetch('admin-subject.jsp?action=getSubject&subject_id=' + subjectId)
                                        .then(response => response.json())
                                        .then(data => {
                                            document.getElementById('update_subject_id').value = data.subjectId;
